...
'''
This is a script that contains the implementation of the Restricted Boltzmann Machines (RBM).
'''
class RestrictedBoltzmannMachines:
    logging.basicConfig(format='%(levelname)s:%(message)s', level=logging.INFO)
    class_name = "RestrictedBoltzmannMachines.py"  # f"{__class__.__name__}"
    # Constructor
