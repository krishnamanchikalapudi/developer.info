...
# Contanier details at https://hub.docker.com/_/nginx
...
# -v ${currentFolder}/conf/nginx.conf:/etc/nginx/nginx.conf
docker run -d --name ${containerName} -p ${hostPort}:80 -v ${currentFolder}/html:/usr/share/nginx/html ${containerName} &
